...
Exhaustive reference for all visual particle emissions and sound events utilized across Better Bats on Minecraft 26.1.2.
...
| `ParticleTypes.MYCELIUM` | Guano accumulation on non-crop soil or mature crop | `3` | `dx:0.2, dy:0.1, dz:0.2`, Speed `0.01` | Spore particles over soil block |
| `ParticleTypes.CRIT` | Nighttime phototaxis light orbiting (`BatHuntLightGoal`) | `3` | `dx:0.2, dy:0.2, dz:0.2`, Speed `0.05` | Critical trail particles emitted near light center representing insect feeding |
